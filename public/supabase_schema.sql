...
-- ============================================================================
DO $$ BEGIN
    ALTER PUBLICATION supabase_realtime ADD TABLE staff_users, leads, bookings, tasks, issues, activities, area_checklists, checklist_items, inventory_items, inventory_daily_logs, expenses, monthly_balances, expense_categories;
EXCEPTION
    WHEN undefined_object THEN null;
END $$;

-- ============================================================================
-- 9. COMMERCIALS (EXPENSE TRACKING) MODULE
-- ============================================================================
...
-- Monthly Balances Table (Formula: Closing = Opening - Total Spent)
...
-- Analytical View for Monthly Category Spending
